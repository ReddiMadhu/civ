...
export function Sidebar({ active, setActive }) {
    return (
        <aside className="w-56 shrink-0 flex flex-col h-screen border-r border-border bg-card py-6 sticky top-0">
            {/* Logo */}
            <div className="px-5 mb-8">
                <div className="flex items-center gap-2">
                    <div className="h-8 w-8 rounded-lg bg-primary flex items-center justify-center text-primary-foreground font-bold text-sm">CLV</div>
                    <div>
